...
CapPin cPin_9  = CapPin(9);     // read pin 9 (D9 on Flora)   - connect to NES right
//CapPin cPin_6  = CapPin(6);     // read pin 6 (D6 on Flora)   - connect to NES Start or pause / space
CapPin cPin_1  = CapPin(1);     // read pin 2 (SDA on Flora)  - connect to NES left
...
CapPin pins[] = { cPin_10, cPin_9,cPin_1};
